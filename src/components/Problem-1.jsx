            ...
            <div className="row justify-content-center mt-5">
                ...
                <div className="col-6 ">
                    <form className="row gy-2 gx-3 align-items-center mb-4" onSubmit={handleSubmit}>
                        ...
                        <div className="col-auto">
                            <input type="text" className="form-control"  name="status" placeholder="Status" value={formData.status} onChange={handleInputChange}/>
                        </div>
                        <div className="col-auto">
                ...
                <div className="col-8">
                    ...
                    <table className="table table-striped ">
                        ...
                        <tbody>
                            <TableList formData={submittedData} show={show}/>
                        </tbody>
                    </table>
                </div>
            </div>
